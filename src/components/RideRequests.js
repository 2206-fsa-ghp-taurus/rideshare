      ...
      <div>
        <div>
          {requests && requests.length !== 0 ? (
              ...
              <div key={requests[0].id}>
                ...
                <div className='grid gap-10 my-6 md:grid-cols-2 mx-7'>
                  {requests[0].requestorIds.map((requestor) => (
                    <div
                      id={requests[0]}
                      className='mx-3 card w-auto bg-base-100 shadow-xl my-3 items-center'>
                      ...
                      <button
                        ...
                        rider={requestor}
                        onClick={() => {
                          acceptRide(requests[0], requestor);
                        }}>
                        Accept Ride
                      </button>
                    </div>
            ...
            <div className='text-center font-bold my-7 text-2xl'>
              No rides requested
            </div>
          )}
        </div>
        ...
        <div className='flex items-center justify-center'>
          <button
            className='btn btn-warning my-5 flex justify-center items-center'
            onClick={cancelDrive}>
            Cancel Drive
          </button>
        </div>
