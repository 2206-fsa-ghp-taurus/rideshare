  ...
  return (
    <>
      ...
      <div className='ml-4 mt-5'>
        ...
        <p className='text-center font-bold mb-3'>User Info</p>
        <p className='my-1'>
        ...
        <p className='my-1'>
          TOTAL CARBON FOOTPRINT (kg): {user?.totalFootPrint}{' '}
        </p>
        <p className='my-1'>WALLET($): {user?.wallet} </p>
      </div>
      ...
      <div className='ml-4'>
        <p className='text-center font-bold mb-3'> Car Details </p>
      ...
      <button className='btn btn-warning rounded-full' onClick={handleDelete}>
        {' '}
        Delete Account
        <svg
