    ...
    <>
      ...
      {isDriver ? (
        <div className='mx-5 text-center'>
          <p className='py-2'>
            You Earned:{' '}
            {`$ ${FormatNumber((distance / 1000) * 0.621371 * 0.585)}`}{' '}
          </p>
          <p className='py-2'>
            You Drove the Rider for: {`${FormatNumber(distance / 1000)} km`}
          </p>
          <p className='py-2'>
            You Helped the Rider Save:{' '}
            {`${FormatNumber(((distance / 1000) * 650) / 1000)} kg of carbon`}
          </p>
          <img
            src='https://miro.medium.com/max/606/1*e78xMjlb8Xd0YeIs9PyaaA.png'
            alt='environmental pic'
            className='mx-auto w-1/4 opacity-60'
          />
        ...
        <div className='mx-5 text-center'>
          ...
          <p className='py-2'>
            You Traveled For: {`${FormatNumber(distance / 1000)} km`}
          </p>
          <p className='py-2'>
            You Saved:{' '}
            {`${FormatNumber(((distance / 1000) * 650) / 1000)} kg of carbon`}
          ...
          <img
            src='https://miro.medium.com/max/606/1*e78xMjlb8Xd0YeIs9PyaaA.png'
            alt='environmental pic'
            className='mx-auto md:w-1/4 opacity-60'
          />
          <p className='py-2'>Thank you for helping save our environment!</p>
        </div>
      )}
